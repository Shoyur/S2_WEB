...
let listerAnimaux = (listeAnimaux) =>{
    //Lister les animaux dans le tableau pour tous les cas
    let contenuTable = `
    <div id='divLst'>
    ...
    <table class="table table-primary table-striped table-hover">
            ...
            <tbody>
    `;
    // onClick.toggle c'est pour le petit X rouge qui ferme le tableau
...
let chargement = () => {
    ...
    animaux.forEach(unAnimal => {
        ...
        selAnimaux.options[selAnimaux.options.length] = new Option(unAnimal.nom);
    });
...
let afficherInfosAnimal = () => {
    ...
    // `;
     ...
     // Ceci envoie un tableau avec un seul élément.................................................................................
}